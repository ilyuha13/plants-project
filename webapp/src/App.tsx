  ...
  return (
    <Routes>
      ...
      <Route element={<Layout header={<Header />} mainContent={<Outlet />} cart={<Cart />} footer={<Footer />} />}>
        ...
        <Route path={routes.getGenusDetailRoute(routes.genusDetailRouteParams)} element={<GenusDetailPage />} />
        ...
        />
        <Route path={routes.getAddVariegationPageRoute()} element={<AddVariegationPage />} />
        <Route
