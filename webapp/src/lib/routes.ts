...
export const getEditPlantRoute = ({ plantId }: EditPlantRouteParams) =>
  `/plants/edit/${plantId}`
...
export const getEditGenusRoute = ({ genusId }: EditGenusRouteParams) =>
  `/genus/edit/${genusId}`
...
export const getEditLifeFormRoute = ({ lifeFormId }: EditLifeFormRouteParams) =>
  `/lifeForm/edit/${lifeFormId}`
